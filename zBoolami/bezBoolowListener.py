...
class bezBoolowListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by bezBoolowParser#printSeq.
    def enterPrintSeq(self, ctx: bezBoolowParser.PrintSeqContext):
        pass

    # Exit a parse tree produced by bezBoolowParser#printSeq.
    def exitPrintSeq(self, ctx: bezBoolowParser.PrintSeqContext):
        pass
    ...
    # Enter a parse tree produced by bezBoolowParser#inputSeq.
    def enterInputSeq(self, ctx: bezBoolowParser.InputSeqContext):
        pass

    # Exit a parse tree produced by bezBoolowParser#inputSeq.
    def exitInputSeq(self, ctx: bezBoolowParser.InputSeqContext):
        pass

    # Enter a parse tree produced by bezBoolowParser#filename.
    def enterFilename(self, ctx: bezBoolowParser.FilenameContext):
        pass

    # Exit a parse tree produced by bezBoolowParser#filename.
    def exitFilename(self, ctx: bezBoolowParser.FilenameContext):
        pass
